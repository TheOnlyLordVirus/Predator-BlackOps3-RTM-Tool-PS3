...
namespace CS_ClassLibraryTester
{
    ...
    class NYX_Theme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            if (Animated == true)
            {
                ...
                bg_cblend.Colors[1] = Color.FromArgb(Red, Green, Blue);
            ...
            G.DrawString(Text, titleFont, new SolidBrush(Color.FromArgb(Red, Green, Blue)), new Point(m - (textWidth / 2), 4));
        }
    }

    class NYX_Button : ThemeControl154
    {
        //Coded by HΛWK
        ...
        protected override void PaintHook()
        {
            ...
            //Background
            ColorBlend bg_cblend = new ColorBlend(3);
            bg_cblend.Colors[0] = Color.FromArgb(50, 50, 50);
            bg_cblend.Colors[1] = Color.FromArgb(50, 50, 50);
            bg_cblend.Colors[2] = Color.FromArgb(50, 50, 50);
            bg_cblend.Positions = new [] {0,(float)0.6,1 };
    ...
    class NYX_ProgressBar : ThemeControl154
    {
        //Coded by HΛWK
    ...
    class NYX_GroupBox : ThemeContainer154
    {
        //Rainbow added by Lord Virus
        public System.Timers.Timer RainbowTimer = new System.Timers.Timer();
        int Red = (0);
    ...
    class NYX_ControlBox : ThemeControl154
    {
        //Coded by HΛWK
    ...
    class NYX_CheckBox : ThemeControl154
    {
        //Coded by HΛWK
