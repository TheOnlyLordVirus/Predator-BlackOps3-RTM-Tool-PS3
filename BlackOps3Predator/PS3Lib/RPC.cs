...
namespace BlackOps3Predator
{
    class RPC
    {
        public static PS3API PS3 = (BlackOps3Predator.BaseForm.PS3);//public static PS3API PS3 = new PS3API(); <-- Add this to your main form to share your object.
        ...
        {
            Call(0x5EC544, Client, 1, Command);
        }

        public static void SV_SendServerCommand(int Client, string Command)
        {
            Call(0x5F1A84, Client, 1, Command);
        }

        public static void CBuf_Addtext(string Command)
        {
            Call(0x5B1A7C, 0, Command);
        }
